 ...
 <nav id="sidebar" class="lg:min-w-[250px] w-max max-lg:min-w-8">
            <div id="sidebar-collapse-menu" class="bg-white shadow-lg h-screen fixed top-0 left-0 overflow-auto z-[99] lg:min-w-[250px] lg:w-max max-lg:w-0 max-lg:invisible transition-all duration-500">
                <div class="pt-8 pb-2 px-6 sticky top-0 bg-white min-h-[80px] z-[100]">
                    <a href="index.php" class="outline-none">
                ...
                <div class="py-6 px-6">
                    <ul class="space-y-2">
                        <li>
                            <a href="#" id="dashboardBtn" class="menu-item text-black text-sm w-full flex items-center cursor-pointer hover:bg-[#00568881] rounded-md px-3 py-3 transition-all duration-300">
                        ...
                        <li>
                            <a href="/mes-cours" class="menu-item text-gray-800 text-sm flex items-center cursor-pointer hover:bg-[#00568881] rounded-md px-3 py-3 transition-all duration-300">
