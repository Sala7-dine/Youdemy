                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end gap-2">
                                        <!-- Bouton Update -->
                                        <form action="/dashboard/teacher/cours/edit" method="POST" class="inline">
         ...
         <div id="courseModal" class="fixed inset-0 z-50 overflow-y-auto hidden">
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    <form id="courseForm" method="POST" action="<?= isset($editCourse) ? '/dashboard/teacher/cours/update' : '/dashboard/teacher/cours/add-cours' ?>" enctype="multipart/form-data">
                        <?php if(isset($editCourse)): ?>
                            <input type="hidden" name="cours_id" value="<?= $editCourse['id'] ?>">
                        <?php endif; ?>
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="titre" id="titre" required
                                    value="<?= isset($editCourse) ? htmlspecialchars($editCourse['titre']) : '' ?>"
                            ...
                            <div class="mt-4">
                                ...
                                <textarea name="description" id="description" rows="3"
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                ><?= isset($editCourse) ? htmlspecialchars($editCourse['description']) : '' ?></textarea>
                            </div>
                                ...
                                <select name="categorie_id" id="categorie_id" required
                                    ...
                                    <?php foreach($categories as $categorie): ?>
                                        <option value="<?= $categorie['id'] ?>" 
                                            <?= isset($editCourse) && $editCourse['categorie_id'] == $categorie['id'] ? 'selected' : '' ?>>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="grid grid-cols-3 gap-2 max-h-32 overflow-y-auto p-2 border border-gray-300 rounded-md">
                                    <?php 
                                    $selectedTags = isset($editCourse) ? array_column($editCourse['tags'], 'id') : [];
                                    foreach($tags as $tag): 
                                    ?>
                                        <div class="flex items-center">
                                            <input type="checkbox" 
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            <button type="submit" 
                                ...
                                <?= isset($editCourse) ? 'Mettre à jour' : 'Ajouter' ?>
                            </button>
                            <a href="/dashboard/teacher/cours" 
